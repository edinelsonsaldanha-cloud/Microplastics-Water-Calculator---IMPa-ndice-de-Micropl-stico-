...
class TelaResultados(QWidget):
    def __init__(self, main_window):
        ...
        self.setWindowTitle("Results – IMPa-L, IMPa-A, and Count-Based Microplastic Concentration (MP)")
        self.resize(950, 700)
        ...
        if not self.pasta_projeto:
            QMessageBox.critical(self, "Erro", "No active project.")
        ...
        if not os.path.exists(self.caminho_resultados):
            QMessageBox.critical(self, "Erro", "IMPa-L results not found.")
            self.main_window.mostrar_tela_inicial()
            return
    ...
    def formatar_resultados(self):
        ...
        linhas.append("=== IMPa-L per Sampling Unit (µm/L) ===")
        ...
        linhas.append("\n=== Count-Based Microplastic Concentration (MP) by Morphological Category per Sampling Unit (Items/L) ===")
    ...
    def init_ui(self):
        ...
        btn_impa_ponto = QPushButton("IMPₐ-L Point")
        btn_impa_tipo = QPushButton("IMPₐ-L by Morphologic")
        btn_impa_percentual = QPushButton("IMPₐ-L Percent")
        btn_impa_matriz = QPushButton(" IMPₐ-L Matrix")
        ...
        btn_mp_ponto = QPushButton("MP by Point")
        btn_mp_tipo = QPushButton("MP by Morphologic")
        btn_mp_percentual = QPushButton("MP Percentual")
        btn_mp_matriz = QPushButton("MP Matrix")
        ...
        btn_area_ponto = QPushButton("IMPₐ–A by Point")
        btn_area_tipo = QPushButton("IMPₐ–A by Morphologic")
        btn_area_percentual = QPushButton("IMPₐ–A Percent")
        btn_area_matriz = QPushButton("IMPₐ–A Matrix")
        ...
        btn_dist = QPushButton("Distribution of Microplastic")
        btn_box = QPushButton("Boxplot IMPₐ–L")
        btn_box_area = QPushButton("Boxplot IMPₐ–A")
        btn_pca = QPushButton("PCA IMPₐ–L and MP")
