...
class TelaInicial(QWidget):
    ...
    def init_ui(self):
        ...
        lbl_uni = QLabel("UNIVERSIDADE FEDERAL DO PARÁ")
        lbl_lab = QLabel(
            "LABOTARÓRIO DE GEOQUÍMICA AMBIENTAL COSTEIRA E OCEÂNICA - LABGECO"
        )
        ...
        # Título do sistema
        # ===============================
        titulo = QLabel("QUANTIFICAÇÃO DE MICROPLASTICOS\nÍndice de Microplásticos em Matrizes de Água, Solo e Alimentos - IMPₐ\nVersão 1.0")
        titulo.setAlignment(Qt.AlignCenter)
        titulo.setStyleSheet("font-size:16px; font-weight:bold;")

        subtitulo = QLabel(
            "Quantificação Baseada na Contagem, Comprimento, Área e na Morfologia"
        )
        ...
        # Botões de projeto
        # ===============================
        btn_novo = QPushButton("Criar Novo Projeto")
        btn_abrir = QPushButton("Abrir Projeto Existente")
        ...
        # Botões de trabalho
        # ===============================
        btn_pontos = QPushButton("Cadastrar Pontos Amostrais")
        btn_calibracao = QPushButton("Calibração Microscópica")
        btn_medicao = QPushButton("Medição de Microplásticos")
        btn_resultados = QPushButton("Resultados (IMPₐ / MP)")
        ...
        # ===============================
        rodape = QLabel(
            "Produzido e Desenvolvido pelo Prof. Dr. Edinelson Saldanha"
        )
